...
void ( APIENTRY * qglLockArraysEXT)( GLint, GLint); //jens la till GL till "int"
...
static void ( APIENTRY * dllColor3bv )(GLbyte *v);
static void ( APIENTRY * dllColor3d )(GLdouble red, GLdouble green, GLdouble blue);
static void ( APIENTRY * dllColor3dv )(GLdouble *v);
...
static void APIENTRY logColor3bv(GLbyte *v)
{
...
static void APIENTRY logColor3dv(GLdouble *v)
{
...
static void APIENTRY logColor3iv(GLint *v)
{
...
static void APIENTRY logColor3sv(GLshort *v)
{
...
static void APIENTRY logColor3ubv(GLubyte *v)
{
...
static void APIENTRY logColor3uiv(GLuint *v)
{
	SIG( "glColor3uiv" );
	dllColor3uiv( v );
}
...
static void APIENTRY logColor3usv(GLushort *v)
{
	SIG( "glColor3usv" );
	dllColor3usv( v );
}
...
static void APIENTRY logColor4bv(GLbyte *v)
{
	SIG( "glColor4bv" );
	dllColor4bv( v );
}
...
static void APIENTRY logColor4dv(GLdouble *v)
{
	SIG( "glColor4dv" );
	dllColor4dv( v );
}
...
static void APIENTRY logColor4iv(GLint *v)
{
	SIG( "glColor4iv" );
	dllColor4iv( v );
}
...
static void APIENTRY logColor4sv(GLshort *v)
{
	SIG( "glColor4sv" );
	dllColor4sv( v );
}
...
static void APIENTRY logColor4ubv(GLubyte *v)
{
	SIG( "glColor4ubv" );
	dllColor4ubv( v );
}
...
static void APIENTRY logColor4uiv(GLuint *v)
{
	SIG( "glColor4uiv" );
	dllColor4uiv( v );
}
...
static void APIENTRY logColor4usv(GLushort *v)
{
	SIG( "glColor4usv" );
	dllColor4usv( v );
}
...
void * qwglGetProcAddress(char *symbol) {
	//todo jens Behövs denna?
	status_t stat;
	printf("- - - GetProc In %s\n", symbol);
	void *test;
	stat = get_image_symbol(glw_state.OpenGLLib, symbol, B_SYMBOL_TYPE_TEXT, (void**)&test);
	if (stat == B_OK)
		return test;
	else
		return NULL;
...
extern "C" qboolean QGL_Init( const char *dllname ) {
	/*	On Linux this function dynamically loads the GL library.
		We don't need this on BeOS as we link to libGL.so at
		compile time. We find the image_id of our libGL
		so we can get_image_symbol() from it later on. */
	...
	} while (!strcmp(path.Leaf(), "libGL.so") == 0);

	glw_state.OpenGLLib = info.id;
	...
	qglGetTexLevelParameterfv			=	dllGetTexLevelParameterfv	=NULL;//jens=	glGetLevelParameterfv;
	qglGetTexLevelParameteriv			=	dllGetTexLevelParameteriv	=NULL;//jens=	glGetLevelParameteriv;
